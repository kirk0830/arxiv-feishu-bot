"""Tests for lark_arxivbot.arxiv module."""
...
@patch("lark_arxivbot.arxiv.arxiv.Client")
...
@patch("lark_arxivbot.arxiv.requests.get")
...
def test_fetch_papers_from_arxiv_fallback(mock_client_cls: MagicMock) -> None:
    ...
    with patch(
        "lark_arxivbot.arxiv._fetch_via_atom_api"
    ) as mock_atom:
...
@patch("lark_arxivbot.arxiv.socket.gethostbyname")
@patch("lark_arxivbot.arxiv.requests.get")
